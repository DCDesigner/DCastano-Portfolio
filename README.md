...
a.	As a first time visitor, I want to easily visualize the persons skills and professional/educational background.

b.	As a first time visitor, I want to be able to easily navigate throughout the site to find sample work, resume and social media.
...
a.	The main colors are different tones of purple, pink, blues and touches of yellow which is the opposite color of purple. I picked these colors because I wanted different shades to represent some words, I had in mind that I wanted to represent visually. Words like feminine, balance, creative, and energy. The colors all looked good when combined.
...
c.	The typewriter effect on the top left was used to represent visually what developers do a lot which is type. Therefore, I used it to welcome visitors and describe a few things that I can do.

**Imagery**

a.	The large main image at the top represents the creator of the site at work on her desk with a background of where she grew up. With details showing what she is working on the side.
...
e.	For the skills I wanted one main image to represent each category list. This would make it easy to read and have one visual representation to balance the list of text.
...
1.	[**Bootstrap 4.4.1:**](https://getbootstrap.com/docs/4.4/getting-started/introduction/) Bootstrap was used to create a responsive website.
...
I used the scroll down symbol on top of the yellow computer image to let visitors know to scroll down the page, there is more to see. This was created my [Hasan](https://bootsnipp.com/snippets/0e6dy).
Back to top button uses JavaScript so that its faster to go up to the top again. I noticed the link no longer works to give credit to [Hasan](https://bootsnipp.com/snippets/0e6dy). 
The portfolio gallery uses JavaScript for an easy transition when finding sample work organized into different categories. [Link to Agustin Guanipa gallery snippet](https://bootsnipp.com/snippets/yyQq1).
The typewriter at the top of my page was created by [Daniel Groen](https://codepen.io/Danielgroen/pen/VeRPOq). 
*Note- I customized all these snippets to fit my visual needs of how I wanted my website to look like.

5.	[**Git:**](https://git-scm.com/) Git was used for version control by utilizing the Gitpod terminal to commit to Git and Push to GitHub. Gitpod was where I did all my editing of the website and previews.
6.	[**GitHub:**](https://github.com/) GitHub is used to store the projects code after being pushed from Git.
7.	[**Illustrator:**](https://www.adobe.com/ie/products/photoshop.html)
...
* [View Markup Validator testing here.](https://github.com/DCDesigner/DCastano-Portfolio/blob/master/assets/images/readme_files/W3CValidator.png) 

[W3C CSS Validator](http://www.css-validator.org/)

* [View my CSS Validator testing here.](https://github.com/DCDesigner/DCastano-Portfolio/blob/master/assets/images/readme_files/W3CCSSValidator.png)

[Dev tools Lighthouse](https://developers.google.com/web/tools/lighthouse)

* [View Lighthouse testing here.](https://github.com/DCDesigner/DCastano-Portfolio/blob/master/assets/images/readme_files/lighthouse_test.png)
...
1. There are known bugs on both the html and css due to the snippets I used from [Agustin Guanipa gallery snippet](https://bootsnipp.com/snippets/yyQq1). The image src are being added dynamically from line 53 of my gallery.js file.
2.	There are 1196 errors and 1302 warnings that I am aware about in the CSS validator. Some come from [bootstrap/4.4.1](https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css)
3.	The other errors or warnings are from the snippets that I used from other coders that I credited.
4.	The images in my portfolio section sometimes load slow on desktop. I checked on other devices and it fine. I did size them down to less than 2,500px. I researched in several websites they all say different sizes. [Link to size reference](https://www.foregroundweb.com/image-size/) I also tested the speed of my website with Page speed insight from Google. I can see the images halfway loaded if I scroll immediately superfast to the portfolio section. But since I know visitors will take a bit of time to get to that section its fine. Its only the photography section images that take a bit more to load.
5.	For media query screen size galaxy fold 280px, the word portfolio is sticking out a bit causing the website to have a horizontal scroll. This is a known issue because I want the font size of h1 to big as big as possible on all devices. I can into an issue because the only screen size that was not looking good was the galaxy. Therefore, in the h1 tag I wanted to put a media query with a smaller font size and it did not work. The h1 tag as the !important so that the main font loads and not the fallback fonts. This causes issues when wanting to put !important on the new font size for the media query, because it will override. As the tutor mentioned I have to several !important which its suggested not to use, because this like this will happen. So I had to choose a font size that would be at least visible to all screen sizes even though the galaxy fold has a horizontal scroll. I am aware and ok with that.
...
2.	At the top of the Repository (not top of page), locate the "Settings" Button on the menu. Alternatively [Click Here](https://raw.githubusercontent.com/) for a GIF demonstrating the process starting from Step 2.
3.	Scroll down the Settings page until you locate the "GitHub Pages" Section.
4.	Under "Source", click the dropdown called "None" and select "Master Branch".
5.	The page will automatically refresh.
6.	Scroll back down through the page to locate the now published [site link](https://dcdesigner.github.io/DCastano-Portfolio/) in the "GitHub Pages" section.

## Forking the GitHub Repository<h2>
By forking the GitHub Repository we make a copy of the original repository on our GitHub account to view and/or make changes without affecting the original repository by using the following steps...
1.	Log in to GitHub and locate the [GitHub Repository](https://github.com/)
2.	At the top of the Repository (not top of page) just above the "Settings" Button on the menu, locate the "Fork" Button.
3.	You should now have a copy of the original repository in your GitHub account.

## Making a Local Clone<h2>
1.	Log in to GitHub and locate the [GitHub Repository](https://github.com/)
...
# Credits<h1>
## Code<h2>
*	The scroll symbol was created my [Hasan](https://bootsnipp.com/snippets/0e6dy).
*	Back to top button uses JavaScript so that its faster to go up to the top again. I noticed the link no longer works to give credit to [Hasan](https://bootsnipp.com/snippets/0e6dy).
*	The portfolio gallery uses JavaScript for an easy transition when finding sample work organized into different categories. Link to [Agustin Guanipa gallery snippet](https://bootsnipp.com/snippets/yyQq1).
*	The typewriter at the top of my page was created by [Daniel Groen](https://codepen.io/Danielgroen/pen/VeRPOq`). 
...
*	To find inspiration on colors I used [Coolors](https://coolors.co/cbff8c-e3e36a-c16200-881600-4e0110).
*	The [meaning of colors](https://www.color-meanings.com/) and why help me decide.

## Media<h2>
*	All Images were created by the developer and used [fontawesome](https://fontawesome.com/) for icons.
Acknowledgements
...
I am also aware that I should use different commit messages and I will use in the future. THe website looks great and minimalistic.
